...
function renderData() {
  translations = {
    ...
    "french": {
      ...
      "desAbout1": "LexDesk360 est une plateforme de solutions juridiques de nouvelle génération, conçue pour les entreprises à forte croissance, actives à l’international et qui ont besoin d’un accompagnement juridique et conformité en phase avec leur rythme.",
      "desAbout2": "Avec des hubs à Dubaï, Limassol et Le Caire, et un réseau couvrant les États-Unis, la région EMEA et l’Asie du Sud, LexDesk360 combine des standards juridiques internationaux avec une expertise locale pointue. Nos solutions sont conçues pour simplifier le business, minimiser les risques et soutenir la croissance. Qu’il s’agisse de conformité, de gestion des litiges ou de conseil juridique stratégique, LexDesk360 est le partenaire qui fait avancer votre entreprise sans obstacles.",
      "Vision": "Vision",
      "tilteVision": "LÀ OÙ LES AVOCATS PARLENT BUSINESS.",
      "desVesion1": "Chez LexDesk360, nous imaginons un monde où l’expertise juridique porte le progrès des entreprises. En alliant intégrité et innovation, nous redéfinissons les services juridiques pour qu’ils soient non seulement irréprochables en droit, mais aussi stratégiques sur le plan commercial.",
      "desVesion2": "Nous donnons aux meilleurs talents juridiques les moyens de proposer des solutions agiles et rentables, qui aident les entreprises à prospérer, à se développer et à s’imposer au-delà des frontières.",
      "desVesion3": "Cette vision repense le rôle du conseil juridique comme un moteur stratégique de croissance, plutôt qu’un centre de coût. Nous nous engageons à transformer la conformité en avantage concurrentiel et les environnements réglementaires complexes en parcours clairs d’expansion.",
      "desVesion4": "Notre objectif est de faire en sorte que, des startups aux multinationales, chaque entreprise ait accès à des stratégies juridiques qui non seulement protègent la valeur, mais en créent activement, transformant l’ambition en réalité concrète.",
      "Mission": "Mission",
      "MissionT": "DES SOLUTIONS JURIDIQUES AXÉES SUR LE BUSINESS, SANS FRONTIÈRES.",
      "desMission1": "Offrir des services juridiques transfrontaliers de tout premier plan, avec transparence, flexibilité et alignement sur les enjeux business, afin de permettre à nos clients de se concentrer sur leur croissance pendant que nous prenons en charge la complexité juridique.",
      "desMission2": "Nous y parvenons en nous immergeant au cœur des secteurs d’activité et des objectifs stratégiques de nos clients. Notre équipe de professionnels du droit de haut niveau délivre des conseils sur mesure, concrets et opérationnels, à la fois réactifs et orientés vers les résultats commerciaux.",
      "desMission3": "Grâce à notre réseau de hubs mondiaux – de Dubaï, du Caire et de Limassol jusqu’aux principaux marchés internationaux – nous allions des standards de classe mondiale à une connaissance locale précise. Nous élevons les standards d’excellence juridique en transformant les obstacles potentiels en opportunités de croissance durable et de leadership sur le marché.",
