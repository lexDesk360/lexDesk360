...
const translationsData = {
  eng: {
    ...
    tjoin1: "Counsel Application Form",
    tjoin2: "International Network Law Firm Application Form",
    tjoin3: "Channel Partner Application Form",
    tjoin4: "Lawyers Application Forms",
    tjoin5: "Careers Forms",
  ...
  ar: {
    ...
    tjoin1: "نموذج تقديم المستشار القانوني",
    tjoin2: "نموذج تقديم لشبكة محاماة دولية",
    tjoin3: "نموذج تقديم شريك القناة",
    tjoin4: "نماذج تقديم المحامين",
    tjoin5: "نموذج الوظائف ",
  ...
  greek: {
    ...
    tjoin1: "Φόρμα Αίτησης Counsel",
    tjoin2: "Φόρμα Αίτησης Διεθνούς Δικτύου Δικηγορικών Γραφείων",
    tjoin3: "Φόρμα Αίτησης Partner Δικτύου",
    tjoin4: "Φόρμες Αίτησης Δικηγόρων",
    tjoin5: "Φόρμα Καριέρες",

    name: "Ονοματεπώνυμο",
    emailJoin: "το email σας",
    phone: "Τηλέφωνο",
    UploadFirm: "Upload Firm Profile",
  ...
  french: {
    ...
    tjoin1: "Formulaire de candidature – Counsel",
    tjoin2: "FORMULAIRE DE CANDIDATURE – CABINET MEMBRE DU RÉSEAU INTERNATIONAL",
    tjoin3: "Formulaire de candidature – Channel Partner",
    tjoin4: "Formulaires de candidature – Avocats",
    tjoin5: "Formulaires de Carrièra",

    name: "Nom",
    emailJoin: "Votre e-mail ",
    phone: "Téléphone",
    UploadFirm: "Upload Firm Profile",
  ...
  it: {
    ...
    tjoin1: "Modulo di candidatura Counsel",
    tjoin2: "Modulo di candidatura International Network Law Firm",
    tjoin3: "Modulo di candidatura Channel Partner",
    tjoin4: "Moduli di candidatura avvocati",
    tjoin5: "Moduli di carriera",
